...
const Filter = ({ setFilters }) => {
  ...
  const [requestedSkillLevel, setRequestedSkillLevel] = useState("");
  ...
  return (
    <div className="w-full sm:w-[400px] md:w-[270px] p-4 bg-white rounded-lg shadow-lg">
      ...
      <div className="mb-4">
        <label className="block text-sm font-medium">Offered Skill Level</label>
        <select
          className="w-full mt-2 p-2 border border-gray-300 rounded-md"
      ...
      <div className="mb-4">
        <label className="block text-sm font-medium">Requested Skill</label>
        <select
          className="w-full mt-2 p-2 border border-gray-300 rounded-md"
      ...
      <div className="mb-4">
        <label className="block text-sm font-medium">Requested Skill Level</label>
        <select
          className="w-full mt-2 p-2 border border-gray-300 rounded-md"
          value={requestedSkillLevel}
          onChange={(e) => setRequestedSkillLevel(e.target.value)}
        >
          <option value="">Select Level</option>
          <option value="Beginner">Beginner</option>
          <option value="Intermediate">Intermediate</option>
